...
export default function TakeQuiz() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-100 via-teal-50 to-emerald-100 flex flex-col font-sans relative overflow-hidden">
      ...
      {/* HEADER */}
      <div className="bg-white/70 backdrop-blur-xl shadow-sm sticky top-0 z-30 border-b border-white/30 px-4 h-16 flex items-center justify-between">
      ...
      <div className="max-w-7xl mx-auto w-full flex-1 p-4 flex flex-col md:flex-row gap-6 relative z-10">
        ...
        <div className="flex-1 flex flex-col">
          {currentQuestion ? (
            ...
            <div className="bg-white/70 backdrop-blur-xl p-10 text-center text-gray-500 rounded-3xl border border-white/30">
        ...
        <div className="w-full md:w-72 shrink-0">
          <div className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-lg border border-white/30 p-5 sticky top-24 z-20">
